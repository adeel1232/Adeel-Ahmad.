        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">adeeljs.dev@gmail.com</span>
              <a
                href="mailto:adeeljs.dev@gmail.com"
            ...
            <div className="contact__card">
              ...
              <a
                href="https://api.whatsapp.com/send?phone=+923295391301"
                className="contact__button"
                target="_blank"
                rel="noreferrer"
              >
...
<div className="contact__content">
  ...
  <form ref={form} onSubmit={sendEmail} className="contact__form">
    <div className="contact__form-div">
      <label htmlFor="fullName" className="contact__form-tag">
        Name
      </label>
      <input
        type="text"
        name="fullName"  // <-- updated to match EmailJS template
    ...
    <div className="contact__form-div contact__form-area">
      ...
      <textarea
        name="Project"  // <-- updated to match EmailJS template
